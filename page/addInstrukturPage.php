...
<div class="container p-3 m-4 h-100" style="background-color: #FFFFFF; border-top: 5px
    ...
    <hr>
    <table class="table ">
        <form action="../process/addInstrukturProcess.php" method="post" enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" id="ussername" name="ussername" aria-describedby="emailHelp" required>
            </div>
            <div class="mb-3"> 
